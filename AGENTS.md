...
- Report suspected upstream vulnerabilities privately through Microsoft `SECURITY.md`; keep report content, correspondence, private-project context, and standalone exploit instructions out of public Git.
